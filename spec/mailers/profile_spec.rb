...
RSpec.describe ProfileMailer, type: :mailer do
  ...
  before(:example, update_profile: true) do
    user.profile.update(first_name: 'Cliff', last_name: 'Burton')
  end

  describe 'update_profile' do
    let(:mail) { ProfileMailer.with(user:).update_profile }
  ...
  describe 'profile_approved' do
    let(:mail) { ProfileMailer.with(user:).profile_approved }
    ...
    context 'when profile is complete', update_profile: true do
      it 'renders the text body' do
  ...
  describe 'approval_revoked' do
    let(:mail) { ProfileMailer.with(user:).approval_revoked }
